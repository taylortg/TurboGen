...
enum class FileKey { SPEED, MASS_FLOW, INLET_FLOW_ANGLE, 					// OperatingConditions 
			   		 R1H, R1T, R2, B2, BETA1H, BETA1T, BETA2,
			   		 BLOCKAGE1, BLOCKAGE2, NUM_BLADES, AXIAL_LENGTH_RATIO,	// Geometry
...
template <typename T>
bool setPropertyFromFileContent(const std::map<std::string, std::string>& fileContent,
