    ...
    try {
        ...
        if (htmlFlag) {
            ...
            if (file.is_open()) {
                ...
                file << formatTableRow("Hub radius", "mm", impeller.inlet.geom.r1h, 2);
                file << formatTableRow("RMS radius", "mm", impeller.inlet.geom.r1rms, 2);
                file << formatTableRow("Tip radius", "mm", impeller.inlet.geom.r1t, 2);
                file << formatTableRow("Hub metal angle", "°", impeller.inlet.geom.beta1h, 2);
                file << formatTableRow("RMS metal angle", "°", impeller.inlet.geom.beta1rms, 2);
                file << formatTableRow("Tip metal angle", "°", impeller.inlet.geom.beta1t, 2);
                file << formatSubHeaderRow("Impeller exit");
                file << formatTableRow("Radius", "mm", impeller.inlet.geom.r2, 2);
                file << formatTableRow("Blade tip width", "mm", impeller.inlet.geom.b2, 2);
                file << formatTableRow("Blade metal angle", "°", impeller.inlet.geom.beta2, 2);
                file << formatSubHeaderRow("General");
                file << formatTableRow("Inlet area", "mm^2", impeller.inlet.geom.area1 * 1000000.0, 0);
                file << formatTableRow("Inlet throat area", "mm^2", impeller.inlet.geom.throatArea * 1000000.0, 0);
                file << formatTableRow("Outlet area", "mm^2", impeller.outlet.geom.area2 * 1000000.0, 0);
                file << formatTableRow("Axial length - OD ratio", "", impeller.outlet.geom.axialLengthRatio, 4);
                file << formatTableRow("Inlet blockage factor", "", impeller.inlet.geom.blockage1, 4);
                file << formatTableRow("Outlet blockage factor", "", impeller.outlet.geom.blockage2, 4);
                file << formatTableRow("Number of blades", "", impeller.inlet.geom.Z, 0);
                file << fmt::format("\t\t</table>\n");
                ...
                file << formatTableRow("Total enthalpy", "kJ/kg", impeller.inlet.total.props.H, 0);
                file << formatTableRow("Total entropy", "kJ/kg-K", impeller.inlet.total.props.S, 2);
                ...
                file << formatTableRow("Static enthalpy", "kJ/kg", impeller.inlet.static_.props.H, 0);
                file << formatTableRow("Static entropy", "kJ/kg-K", impeller.inlet.static_.props.S, 2);
                file << formatSubHeaderRow("Impeller exit");
                ...
                file << formatTableRow("Total enthalpy", "kJ/kg", impeller.outlet.total.props.H, 0);
                file << formatTableRow("Total entropy", "kJ/kg-K", impeller.outlet.total.props.S, 2);
                ...
                file << formatTableRow("Static enthalpy", "kJ/kg", impeller.outlet.static_.props.H, 0);
                file << formatTableRow("Static entropy", "kJ/kg-K", impeller.outlet.static_.props.S, 2);
                file << fmt::format("\t\t</table>\n");
